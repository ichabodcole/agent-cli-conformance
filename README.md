...
> **Status.** The kit runs today, and releases carry a tag of the form `v0.1.12` <!-- x-release-please-version -->
...
```bash
bun add -d 'git+https://github.com/ichabodcole/agent-cli-conformance.git#v0.1.12'
```
...
The `#v0.1.12` pin names the current release tag. <!-- x-release-please-version -->
...
```
NOT CONFORMANT (L0) — 2 core violated, 2 core unverified, 13 core partially covered  /opt/homebrew/bin/git  [acc 0.1.12]
```

<!-- x-release-please-end -->

That line also ends with the kit's own version — `[acc 0.1.12]` <!-- x-release-please-version -->
...
```
CONFORMANT (L0) — 0 core violated, 1 core unverified, 16 core partially covered  ./conforming.ts  [acc 0.1.12]
