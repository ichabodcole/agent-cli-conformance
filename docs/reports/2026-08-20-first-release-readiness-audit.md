...
| ----- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FR-1  | yes — no Release exists, `v0.1.0` is a bootstrap tag                                                                | **actioned.** README now says releasing takes two merges and that `main` holds the next release between them.                                                                                      |
| FR-2  | yes — squash title resolves to the PR title `Develop`                                                               | **actioned** as guidance: the README names merge-or-rebase for the promotion PR and why. The merge itself is a decision at merge time.                                                             |
...
| FR-9  | yes — the test asserted only `< 124`                                                                                | **actioned.** Uniqueness asserted, and the assertion proved to fail on a duplicated code.                                                                                                          |
