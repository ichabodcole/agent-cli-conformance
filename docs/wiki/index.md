...
| [B3](./rules/streams/machine-output-is-parseable.md)              | core       | L0    | implemented | partial  | 5    |
| [B4](./rules/streams/output-is-delivered-whole.md)                | core       | L1    | planned     | partial  | 2    |
| [B5](./rules/streams/machine-mode-holds-on-parser-errors.md)      | core       | L0    | implemented | partial  | 7    |
...
23 rules · 0 `complete` · 23 `partial` · 94 named gaps.
